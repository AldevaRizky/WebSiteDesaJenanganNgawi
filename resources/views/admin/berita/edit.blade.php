                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea name="deskripsi" 
                                  ...
                                  rows="3"
                                  placeholder="Masukkan deskripsi singkat berita (opsional)">{{ old('deskripsi', $berita->deskripsi) }}</textarea>
                        @error('deskripsi')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
...
<style>
    ...
    .image-preview-item .remove-existing-image {
        position: absolute;
        top: 5px;
        right: 5px;
        background: #dc3545;
...
<script>
    ...
    // Image preview for new multiple images
